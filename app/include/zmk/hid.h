...
#define ZMK_HID_REPORT_ID_VIERA_POWER 0x10
#define ZMK_HID_REPORT_ID_VIERA_BRIGHTNESS 0x11
#define ZMK_HID_REPORT_ID_VIERA_RGB 0x12
#define ZMK_HID_REPORT_ID_VIERA_HSB 0x13
#define ZMK_HID_REPORT_ID_VIERA_EFFECT 0x14
#define ZMK_HID_REPORT_ID_VIERA_EFFECT_SPEED 0x15

#if IS_ENABLED(CONFIG_ZMK_USB)
#define ZMK_HID_VIERA_FEATURE_REPORT_DESC_SIZE 94
#else
#define ZMK_HID_VIERA_FEATURE_REPORT_DESC_SIZE 0
#endif
...
#error "A proper consumer HID report usage range must be selected"
...
#if IS_ENABLED(CONFIG_ZMK_USB)
    HID_ITEM(HID_ITEM_TAG_USAGE_PAGE, HID_ITEM_TYPE_GLOBAL, 2), 0x60, 0xFF,
    HID_USAGE(0x61),
    HID_COLLECTION(HID_COLLECTION_APPLICATION),
    HID_USAGE(0x01),
    HID_REPORT_ID(ZMK_HID_REPORT_ID_VIERA_POWER),
    HID_LOGICAL_MIN8(0x00),
    HID_LOGICAL_MAX8(0x01),
    HID_REPORT_SIZE(0x08),
    HID_REPORT_COUNT(0x01),
    HID_FEATURE(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_ABS),
    HID_USAGE(0x02),
    HID_REPORT_ID(ZMK_HID_REPORT_ID_VIERA_BRIGHTNESS),
    HID_LOGICAL_MIN8(0x00),
    HID_LOGICAL_MAX8(0x64),
    HID_REPORT_SIZE(0x08),
    HID_REPORT_COUNT(0x01),
    HID_FEATURE(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_ABS),
    HID_USAGE(0x03),
    HID_REPORT_ID(ZMK_HID_REPORT_ID_VIERA_RGB),
    HID_LOGICAL_MIN8(0x00),
    HID_LOGICAL_MAX16(0xFF, 0x00),
    HID_REPORT_SIZE(0x08),
    ...
    HID_FEATURE(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_ABS),
    HID_USAGE(0x04),
    HID_REPORT_ID(ZMK_HID_REPORT_ID_VIERA_HSB),
    HID_LOGICAL_MIN8(0x00),
    HID_LOGICAL_MAX16(0xFF, 0x00),
    HID_REPORT_SIZE(0x08),
    HID_REPORT_COUNT(0x03),
    HID_FEATURE(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_ABS),
    HID_USAGE(0x05),
    HID_REPORT_ID(ZMK_HID_REPORT_ID_VIERA_EFFECT),
    HID_LOGICAL_MIN8(0x00),
    HID_LOGICAL_MAX8(0x0F),
    HID_REPORT_SIZE(0x08),
    HID_REPORT_COUNT(0x01),
    HID_FEATURE(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_ABS),
    HID_USAGE(0x06),
    HID_REPORT_ID(ZMK_HID_REPORT_ID_VIERA_EFFECT_SPEED),
...
#define ZMK_HOG_REPORT_DESC_SIZE                                                                    \
    (sizeof(zmk_hid_report_desc) - ZMK_HID_VIERA_FEATURE_REPORT_DESC_SIZE)

BUILD_ASSERT(ZMK_HID_VIERA_FEATURE_REPORT_DESC_SIZE <= sizeof(zmk_hid_report_desc));
